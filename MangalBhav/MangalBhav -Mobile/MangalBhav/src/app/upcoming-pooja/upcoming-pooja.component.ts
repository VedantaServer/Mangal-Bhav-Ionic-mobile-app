...
@Component({
  selector: 'app-upcoming-pooja',
  templateUrl: './upcoming-pooja.component.html',
  styleUrls: ['./upcoming-pooja.component.scss'],
  standalone: true,
  imports: [CommonModule, FormsModule, IonicModule]
})
export class UpcomingPoojaComponent implements OnInit {
  userDetails: any;
    ...
    this.api.post(
      ...
      concatMap((res: any) => {
        ...
        const serviceCalls = panditServices.map((service: any) => {
          ...
          // Get today in YYYY-MM-DD format (safe for India timezone)
